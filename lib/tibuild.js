...
if ("ios" === opts.platform) {
  ...
  if (!opts.target || "emulator" === opts.target) {
    if (conf.android.avd.id) opts.I = conf.android.avd.id;
    if (conf.android.avd.skin) opts.S = conf.android.avd.skin;
    if (conf.android.avd.abi) opts.B = conf.android.avd.abi;
  } else if ("dist-playstore" === opts.target) {
